...
const TechnologyAndAdvancements = () => {
  ...
  const fetchArticles = useCallback(async () => {
    try {
      const res = await axios.get(
        `http://localhost:5000/api/articles/genre/Technology_and_Advancements?sort=${sort}&page=${currentPage}&limit=8`
      );
...
export default TechnologyAndAdvancements;
